...
/**
 * Tick the given texture rectangle with new pixel data.
 *
...
/**
 * Tick a rectangle within a planar YV12 or IYUV texture with new pixel
 * data.
 *
...
/**
 * Tick a rectangle within a planar NV12 or NV21 texture with new pixels.
 *
 * You can use SDL_UpdateTexture() as long as your pixel data is a contiguous
...
/**
 * Tick the screen with any rendering performed since the previous call.
 *
